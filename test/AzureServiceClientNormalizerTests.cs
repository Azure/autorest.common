...
namespace AutoRest.Extensions.Azure.Tests
{
    ...
    public class AzureServiceClientNormalizerTests
    {
        ...
        {
            var input = Path.Combine(Core.Utilities.Extensions.CodeBaseDirectory, "Resource", "swagger-odata-spec.json");
        ...
        {
            var input = Path.Combine(Core.Utilities.Extensions.CodeBaseDirectory, "Resource", "resource-external-false.json");
        ...
        {
            var input = Path.Combine(Core.Utilities.Extensions.CodeBaseDirectory, "Resource", "swagger-resource-flattening.json");
