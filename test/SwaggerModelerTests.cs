...
namespace AutoRest.Modeler.Tests
{
    ...
    public class SwaggerModelerTests
    {
        ...
        public void TestcodeModelWithNoContent()
        {
            ...
            var methods = codeModel.Methods.ToList();
            Assert.Equal("DeleteBlob", methods[3].Name);
            Assert.True(methods[3].ReturnType.Body.IsPrimaryType(KnownPrimaryType.Object));
            Assert.True(methods[3].Responses[HttpStatusCode.OK].Body.IsPrimaryType(KnownPrimaryType.Object));
            Assert.Null(methods[3].Responses[HttpStatusCode.BadRequest].Body);
        }
        ...
        public void TestcodeModelWithDifferentReturnsTypesBasedOnStatusCode()
        {
            ...
            Assert.NotNull(codeModel);
            var methods = codeModel.Methods.ToList();
            Assert.Equal("GetSameResponse", methods[2].Name);
            Assert.Equal("IList<Pet>", CreateCSharpResponseType(methods[2].ReturnType));
            Assert.Equal("IList<Pet>", CreateCSharpResponseType(methods[2].Responses[HttpStatusCode.OK]));
            Assert.Equal("IList<Pet>", CreateCSharpResponseType(methods[2].Responses[HttpStatusCode.Accepted]));

            Assert.Equal("PostInheretedTypes", methods[3].Name);
            Assert.Equal("Pet", CreateCSharpResponseType(methods[3].ReturnType));
            Assert.Equal("Dog", CreateCSharpResponseType(methods[3].Responses[HttpStatusCode.OK]));
            Assert.Equal("Cat", CreateCSharpResponseType(methods[3].Responses[HttpStatusCode.Accepted]));
        ...
        public void TestcodeModelWithStreamAndByteArray()
        {
            ...
            Assert.NotNull(codeModel);
            var methods = codeModel.Methods.ToList();
            Assert.Equal("GetWithStreamFormData", methods[1].Name);
            Assert.Equal("Stream", methods[1].Parameters[0].ModelType.Name);
            Assert.Equal("Stream", CreateCSharpResponseType(methods[1].ReturnType));
            Assert.Equal("Stream", CreateCSharpResponseType(methods[1].Responses[HttpStatusCode.OK]));

            Assert.Equal("PostWithByteArrayFormData", methods[0].Name);
            Assert.Equal("ByteArray", methods[0].Parameters[0].ModelType.Name);
            Assert.Equal("ByteArray", CreateCSharpResponseType(methods[0].ReturnType));
            Assert.Equal("ByteArray", CreateCSharpResponseType(methods[0].Responses[HttpStatusCode.OK]));

            Assert.Equal("GetWithStream", methods[3].Name);
            Assert.Equal("Stream", CreateCSharpResponseType(methods[3].ReturnType));
            Assert.Equal("Stream", CreateCSharpResponseType(methods[3].Responses[HttpStatusCode.OK]));

            Assert.Equal("PostWithByteArray", methods[2].Name);
            Assert.Equal("ByteArray", CreateCSharpResponseType(methods[2].ReturnType));
            Assert.Equal("ByteArray", CreateCSharpResponseType(methods[2].Responses[HttpStatusCode.OK]));
        }
